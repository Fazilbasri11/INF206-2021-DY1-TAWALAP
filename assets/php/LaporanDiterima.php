...
include('koneksi.php');
$query = mysqli_query($koneksi, "SELECT * FROM tamu WHERE konfirmasi='IYA'");
?>
...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="LaporanDiterima.php" class="nav__link active">
    ...
    <h2 style="margin: 25px 300px; text-align:center; color:white;"> <b>Daftar Laporan Tamu Yang Diterima</b></h2>
