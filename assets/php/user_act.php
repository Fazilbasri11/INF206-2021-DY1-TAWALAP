...
if(isset($_POST['simpan']))
{
    ...
    else
    {
        ...
        {
            if ($file_size1 < 2048000 and ($file_type1 =='image/jpeg' or $file_type1 == 'image/png')){
                $nik = $_POST['nik'];
                ...
                mysqli_query($koneksi, "insert into tamu (id,nik,nama_lengkap, tempat_tanggal_lahir,jenis_kelamin,alamat_asal,pekerjaan,status,tanggal_masuk,tanggal_keluar,no_hp,no_rumah,foto_anda,foto_ktp) VALUES('','$nik','$nama_lengkap','$tempat_tanggal_lahir','$jenis_kelamin','$alamat_asal','$pekerjaan','$status','$tanggal_masuk','$tanggal_keluar','$no_hp','$no_rumah','$image','$image1')");
