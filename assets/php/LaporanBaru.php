...
include('koneksi.php');
$query = mysqli_query($koneksi, "SELECT * FROM tamu WHERE konfirmasi='TIDAK'");
?>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td align="center" valign="baseline"><a class="btn btn-info" href="Konfirmasi.php?nik=<?php echo $row['nik']; ?>">KONFIRMASI</a></td>
                </tr>
            <?php
            }
            ?>
