...
<body class="is-boxed has-animations">
    <div class="body-wrap" style="background-color:#2e617e">
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <p class="text-justify" style="color: white;">Tawalap atau singkatan dari Tamu Wajib Lapor
                        ...
                        <div class="hero-figure anime-element">
                            <svg class="placeholder" width="528" height="396" viewBox="0 0 528 396"></svg>
